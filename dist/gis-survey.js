...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GisSurvey = {}));
    ...
    constructor(coordinate, options = {}) {
      ...
      if (coordinate instanceof Coordinate) {
        ...
        if (coordinate.latitude !== undefined && coordinate.longitude !== undefined) {
          ...
          coordinate.elevation !== undefined ? coordinate.elevation : 
            (coordinate.alt !== undefined ? coordinate.alt : null);
  ...
  exports.CoordinateTransformer = CoordinateTransformer;
  ...
  exports.GeoidModel = GeoidModel;
  exports.GeometryEngine = GeometryEngine;
  exports.GoogleMapsAdapter = GoogleMapsAdapter;
  exports.GoogleMapsElevationService = GoogleMapsElevationService;
  exports.GoogleMapsRenderingStrategy = GoogleMapsRenderingStrategy;
  exports.LayerManager = LayerManager;
  exports.LeafletAdapter = LeafletAdapter;
  exports.LineFeature = LineFeature;
  exports.Map3DInterface = Map3DInterface;
  exports.MapFactory = MapFactory$1;
  exports.MapInterface = MapInterface;
  exports.MeasurementTool = MeasurementTool;
  exports.OffsetTool = OffsetTool;
  exports.PointFeature = PointFeature;
  exports.PolygonFeature = PolygonFeature;
  exports.RenderingStrategy = RenderingStrategy;
  exports.SimpleWGS84Transformer = SimpleWGS84Transformer;
  exports.SimplifiedDrawingTool = SimplifiedDrawingTool;
  exports.SnappingManager = SnappingManager;
  ...
  exports.importFromGeoJSON = importFromGeoJSON;
  exports.initialize = initialize;
  exports.initializeCore = initializeCore;

}));
//# sourceMappingURL=gis-survey.js.map
